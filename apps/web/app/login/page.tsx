  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6">
      <Card className="w-full max-w-sm p-8">
        ...
        {/* GitHub is the primary method */}
        {config?.github ? (
          <a
            href={`${API_BASE_URL}/auth/github/login`}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg bg-white px-3 py-2.5 text-sm font-semibold text-black transition hover:opacity-90"
          >
