...
import { api, startCheckout, type Me, type WorkspaceDetail } from "../lib/api";
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">
            ...
            <span
              ...
              style={{ color: PLAN_ACCENT[current] }}
            >
              {PLAN_LABELS[current]}
            </span>{" "}
            plan
              ...
              {m.max !== null ? (
                <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-[var(--surface-3)]">
                  <div
                    ...
                    style={{
                      width: `${pct}%`,
                      background: near ? "var(--signal)" : "var(--accent)",
                    }}
                  />
                </div>
              ) : null}
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isCurrent ? "color-mix(in oklab, var(--surface-2), transparent 40%)" : undefined,
                  }}
                >
